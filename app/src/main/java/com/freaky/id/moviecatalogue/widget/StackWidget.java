...
public class StackWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.freaky.id.moviecatalogue.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.freaky.id.moviecatalogue.EXTRA_ITEM";
