...
public class MovieProvider extends ContentProvider {
    ...
    static {
        sUriMatcher.addURI(DatabaseContract.AUTHORITY, MovieColumn.TABLE_NAME, FAVORITE);
        sUriMatcher.addURI(DatabaseContract.AUTHORITY, MovieColumn.TABLE_NAME + "/#", FAVORITE_ID);
    }
